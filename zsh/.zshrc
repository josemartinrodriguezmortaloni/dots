...
__conda_setup="$('/home/m4s1t4/anaconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/m4s1t4/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/home/m4s1t4/anaconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/m4s1t4/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
...
# bun completions
[ -s "/home/m4s1t4/.bun/_bun" ] && source "/home/m4s1t4/.bun/_bun"
...
# pnpm
export PNPM_HOME="/home/m4s1t4/.local/share/pnpm"
case ":$PATH:" in
  *":$PNPM_HOME:"*) ;;
...
export PATH="/home/m4s1t4/.pixi/bin:$PATH"
